...
The new tabbed landing-page section uses the dedicated folder:

```text
public/images/new-arrivals/
```

See `NEW_ARRIVALS_IMAGE_GUIDE.md` for the complete filename manifest, Gemini-ready composition rules, recommended dimensions, and section usage.
